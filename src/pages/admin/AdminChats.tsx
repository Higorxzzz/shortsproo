  ...
  return (
    <div className="max-w-7xl mx-auto">
      <h1 className="text-2xl font-bold mb-6">
        {isPt ? "Chat de Suporte" : "Support Chat"}
      </h1>
            ...
            {loadingChats ? (
              ...
              chats.map((chat) => (
                <button
                  ...
                  className={cn(
                    "w-full flex items-start gap-3 p-3 text-left transition-colors border-b border-border/50 hover:bg-muted/50",
              ...
              <div className="border-t border-border p-3">
                <div className="flex gap-2">
                  <Input
                    ...
                    placeholder={isPt ? "Digite sua resposta..." : "Type your reply..."}
                    className="text-sm"
                  />
